...
class GConstants {
  ...
  static const _GET_FITNESS_DECLARATION = API_VERSION+ "/student/requests/get_declaration.php";
  static const _SAVE_FITNESS_DECLARATION = API_VERSION+ "/student/requests/save_declaration.php";
