...
class FrgMessagesAll extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StateFrgMessagesAll();
  }
}

class StateFrgMessagesAll extends State<FrgMessagesAll> with StateHelper {
                ...
                child: Row(
                  children: <Widget>[
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: _data[index].senderImage != null
                                ? NetworkImage(_data[index].senderImage)
                    ...
                    Expanded(
                      ...
                      child: Text(_data[index].messageText,
                  ...
                  children: <Widget>[
                    ...
                    RichText(
                        text: TextSpan(
                          ...
                          TextSpan(
                              text: DateFormat()
                                  .addPattern("dd-MM-yy 'at' hh:mm a")
                                  .format(DateTime.parse(_data[index].date))
                                  .toString(),
                              style: TextStyle(
                                  color: Colors.grey.shade700,
                                  fontSize: 12,
