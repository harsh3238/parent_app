...
import 'package:click_campus_parent/views/polls/poll_details.dart';
...
class StateStudentPollsMain extends State<StudentPollsMain> with StateHelper{
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              trailing: pollList[index]['poll_question_image']!=null?SizedBox(
                width: 50,
                height: 50,
  ...
  Future<void> _getPolls() async {
    ...
    var apiResponse = await http.post(
        GConstants.getPollQuestionsRoute(),
        body: requestBody);
